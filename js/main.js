(() => {
  ...
  const EN = {
    ...
    'fba.meta': 'Fantasy basketball & NBA 2K Pro-Am league · since 2021',
    ...
    'about.p1': 'I’m a developer based in Santa Maria, in southern Brazil. I joined Softaliza as an intern and today I’m a mid-level developer there, building websites and platforms for professional associations and their conferences: membership systems, event sites, payment and e-mail integrations, databases and infrastructure.',
    'about.p2': 'Outside that, I work with companies and on my own projects. That’s where FBA Brasil and Cavalheiro come in: I built both entirely on my own, from data modelling to the screen, and I still maintain them.',
    'about.p3': 'What I sell isn’t the technology: it’s the problem solved and a system that keeps working after handover.',
    'about.f1l': 'Currently',
    'about.f1': 'Mid-level developer at Softaliza',
    'about.f2l': 'Based in',
    ...
    'q5.a': 'I stay around for adjustments, fixes and new modules. FBA Brasil has been live since 2021 and I still maintain it today.',
